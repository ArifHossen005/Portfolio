...
<script>
    GetProjectList();//call na korle toh data dekhte parbo nah 
                ...
                document.getElementById('project-list').innerHTML+=(`<div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
                    <div class="card-body p-0">
                        <div class="d-flex align-items-center">
                            ...
                            <img class="img-fluid" src='${item['thumbnailLink']}' alt="..." height="200" width="250" />
                        </div>
                    </div>
                </div>`)
